  ...
  <div class="carousel-index">
    <div class="carousel-container" :style="`background-color: ${color};`">
      <div
        ...
        :style="
          isRoll == 2
            ? `transform: translateX(-${((100 / carousels.length) * 2).toFixed(4)}%); transition: transform 400ms ease 0s;width: ${carousels.length}00%;`
            : isRoll == 1
              ? `transform: translateX(0); transition: transform 400ms ease 0s;width: ${carousels.length}00%;`
              : `transform: translateX(-${(100 / carousels.length).toFixed(4)}%); transition: transform 0ms ease 0s;width: ${carousels.length}00%;`
        "
      >
        <div
          class="carousel-slide"
          :style="`width: ${(100 / carousels.length).toFixed(4)}%`"
